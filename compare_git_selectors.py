...
def get_git_diff():
    ...
    print("🔍 Checking diff between origin/master and origin/main using merge-base...")
...
def extract_selectors(diff_text):
    ...
    # Split multi-class declarations like class="btn primary"
...
def main():
    ...
    if not added and not removed:
        print("✅ No selector changes found between origin/master and origin/main.")
    else:
